...
class	App:
    def	__init__(self,	window,	window_title, video_source=0):
        ...
        # Create a canvas object to fit the video
    ...
    def	update(self):
        global global_frame1
        check, frame, frame1=self.vid.get_frame(global_frame1)
        global_frame1 = frame1
        ...
        # update frames for snapshot - this will take the latest filter
        self.frame = frame
    # all filters
...
App(tkinter.Tk(), 'Trippy Photo App')
